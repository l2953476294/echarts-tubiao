...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            var myChart = this.echarts.init(this.$refs.city3d);

            this.$.getJSON('/static/buildings.json', (buildingsGeoJSON) => {
                ...
                myChart.setOption({
                    series: [{
                        ...
                        realisticMaterial: {
                            roughness: 0.6,
                            textureTiling: 20,
                            detailTexture: '/static/woods.jpg'
                        },
                        postEffect: {
                            enable: true,
                            bloom: {
